...
const routes = [
    ...
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-login-login-module */ "auth-login-login-module").then(__webpack_require__.bind(null, /*! ./auth/login/login.module */ "./src/app/auth/login/login.module.ts")).then((m) => m.LoginModule),
    },
    {
        path: 'register',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-register-register-module */ "auth-register-register-module").then(__webpack_require__.bind(null, /*! ./auth/register/register.module */ "./src/app/auth/register/register.module.ts")).then((m) => m.RegisterModule),
    },
    {
        path: 'home',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-home-home-module */ "pages-home-home-module").then(__webpack_require__.bind(null, /*! ./pages/home/home.module */ "./src/app/pages/home/home.module.ts")).then((m) => m.HomeModule),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_8__["NavbarComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
...
function NavbarComponent_section_13_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NavbarComponent_section_13_Template_a_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r4.onLogOut(); });
...
NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["app-navbar"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])], decls: 17, vars: 4, consts: [[1, "nav", "fixed-top", "d-flex", "justify-content-between", "px-lg-4"], ["type", "checkbox", "id", "nav-check"], [1, "nav-btn", "mt-3"], ["for", "nav-check"], [1, "nav-header"], [1, "nav-title"], ["src", "../../../assets/img/logo.png", "alt", "Bambu Mobile Logo"], [1, "d-none", "d-lg-flex", "align-items-center"], ["class", "nav-links d-flex align-items-center", 4, "ngIf", "ngIfElse"], ["login", ""], [1, "nav-links", "d-flex", "align-items-center"], [1, "mx-3", "my-0", 2, "display", "inline"], [3, "click"], [3, "routerLink"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! E:\Documentos\Osvaldo\Code\pruebas-tecnicas\bambu-mobile\src\main.ts */"./src/main.ts");
