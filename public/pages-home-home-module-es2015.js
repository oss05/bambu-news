...
function HomeComponent_div_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_9_Template_p_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const category_r3 = ctx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.getCategory(category_r3); });
...
function HomeComponent_div_14_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_14_Template_p_click_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const country_r6 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.getCountry(country_r6.code); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function HomeComponent_article_17_Template(rf, ctx) { if (rf & 1) {
...
class HomeComponent {
    ...
    getAllNews(country) {
        this.api.getAllNews(country).subscribe((news) => {
            const { articles } = news;
            this.articles = articles;
        });
    }
    getCategory(category) {
        this.api.getCategory(category).subscribe((news) => {
            const { articles } = news;
            this.articles = articles;
        });
    }
    getCountry(country) {
        this.api.getCountry(country).subscribe((news) => {
            const { articles } = news;
            this.articles = articles;
        });
    }
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 18, vars: 3, consts: [[1, "home-main"], [1, "container"], [1, "row", "justify-content-center", "justify-content-md-end", "mr-4"], [1, "dropdown", "mx-1"], [1, "dropdown-content"], [3, "click"], [4, "ngFor", "ngForOf"], [1, "container", "my-3"], [1, "row", "justify-content-around"], ["class", "custom-card card mb-3 mb-md-4 mb-lg-5", "style", "width: 21rem;", 4, "ngFor", "ngForOf"], [1, "custom-card", "card", "mb-3", "mb-md-4", "mb-lg-5", 2, "width", "21rem"], [1, "card-img-top", 3, "src", "alt"], [1, "custom-card-body", "card-body", "d-flex", "flex-column"], [1, "card-title", 3, "tooltip"], [1, "card-text", "pr-1"], ["target", "_blank", 1, "btn", "custom-button", 3, "href"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_p_click_7_listener() { return ctx.getAllNews("mx"); });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HomeModule, { declarations: [_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"],
        _pipes_truncate_pipe__WEBPACK_IMPORTED_MODULE_5__["TruncatePipe"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _home_routing_module__WEBPACK_IMPORTED_MODULE_2__["HomeRoutingModule"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_3__["TooltipModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
                declarations: [
                    _home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"],
                    _pipes_truncate_pipe__WEBPACK_IMPORTED_MODULE_5__["TruncatePipe"]
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                    _home_routing_module__WEBPACK_IMPORTED_MODULE_2__["HomeRoutingModule"],
...
class TruncatePipe {
    transform(value, limit = 52, completeWords = true, ellipsis = '...') {
        if (completeWords) {
