...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-login-login-module"], {
  ...
  function srcAppAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 31,
      vars: 3,
      consts: [[1, "login-signup-container", "d-flex", "justify-content-center", "align-items-center"], [1, "box"], ["id", "header"], ["id", "cont-lock"], [1, "material-icons", "lock"], ["id", "bottom-head"], ["id", "logintoregister"], [3, "formGroup", "ngSubmit"], [1, "group"], ["type", "text", "required", "", "formControlName", "email", 1, "inputMaterial"], [1, "highlight"], [1, "bar"], ["type", "password", "required", "", "formControlName", "password", 1, "inputMaterial"], ["id", "buttonlogintoregister", "type", "submit"], ["id", "buttonlogintoregister2", "type", "submit", 3, "click"], ["id", "footer-box", 1, "d-flex", "justify-content-center", "align-items-center"], [1, "footer-text"], [1, "sign-up", 3, "routerLink"]],
  ...
  function srcAppAuthLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_3__["LoginRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]]]
    });
